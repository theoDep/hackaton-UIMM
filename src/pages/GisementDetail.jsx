...
export default function GisementDetail() {
  ...
  return (
    <section className="flex justify-center flex-col">
      <h1 className="text-center font-semibold my-6 font-custom text-2xl text-[#702315] mb-0">{gisement.lib_gisement}</h1>
      <div className="avatar ">
        <div className="w-full rounded-xl m-8 mb-0 mt-0 p-6">
          <img src="https://picsum.photos/800/500" />
        </div>
      </div>
      <div>
        <h2 className="text-2xl text-center my-6 bg-[#702315] p-2 text-white mb-0 rounded-sm m-8">Description</h2>
        ...
        <div className="card w-full bg-base-100 shadow-2xl">
          <div className="card-body m-8 shadow-2xl rounded-xl mt-0 bg-[#702315] text-white mb-8 text-center">
