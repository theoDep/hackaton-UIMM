...
const AjouterGisement = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center m-4">
      <h1 className="text-2xl text-center font-bold m-2 text-gray-700">Formulaire ajouter un Gisement</h1>
      <div className="w-full max-w-sm bg-white rounded-lg shadow-lg p-8 mb-8">
        <form /* onSubmit={handleSubmit} */ className="flex flex-col space-y-4">
          <div>
            ...
            <input type="text" id="nom" name="nom" className="form-input w-full" />
          </div>
          <div>
          ...
          <div className="relative">
            <label htmlFor="photo" className="block font-medium text-gray-700 mb-2 text-center">Photo prise</label>
          ...
          <button type="submit" className="bg-red-500 text-white px-4 py-2 rounded-lg shadow-md hover:bg-green-600 transition-colors duration-300 mt-8">
            Ajouter
          </button>
        </form>
      </div>
