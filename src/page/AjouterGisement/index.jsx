...
const AjouterGisement = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center m-8 hover:bg-white">
      <h1 className="text-2xl text-center m-2 text-gray-700 font-medium">Formulaire d'ajout de gisement</h1>
      <div className="w-full max-w-sm bg-white rounded-lg shadow-lg p-8 mb-8">
        <form /* onSubmit={handleSubmit} */ className="flex flex-col space-y-4">
          <div>
            <label htmlFor="nom" className="block font-medium text-gray-700 mb-2">Nom du gisement</label>
            <input type="text" id="nom" name="nom" className="form-input input input-bordered w-full max-w-xs focus:outline-none focus:border-[#702315]" />
          </div>
          <div>
            <label htmlFor="nom" className="block font-medium text-gray-700 mb-2">Description</label>
            <input type="text" id="nom" name="nom" className="form-input input input-bordered w-full max-w-xs focus:outline-none focus:border-[#702315]" />
          </div>
          <div className="relative">
            <label htmlFor="photo" className="block font-bold text-gray-700 mb-2 text-center">Photo prise</label>
          ...
          <button type="submit" className="bg-[#702315] hover:bg-[#49160d] text-white px-4 py-2 rounded-lg shadow-md transition-colors duration-300 mt-8">
            Ajouter
          </button>
        </form>
      </div>
