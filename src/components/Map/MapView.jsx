...
const Map = (props) => {
  ...
  return (
    <div className="map-container">
      ...
      <MapContainer center={state.currentLocation} zoom={state.zoom} whenReady={(map) => {
     ...
     {/* Ajouter des marqueurs pour chaque lieu dans les données */}
        ...
        {/* Ajouter un marqueur pour la position de l'utilisateur si elle est disponible */}
        {state.userLocation && (
          <Marker position={[state.userLocation.lat, state.userLocation.lng]} icon={L.icon({ iconUrl: pointerIcon, iconSize: [32, 32] })}>
